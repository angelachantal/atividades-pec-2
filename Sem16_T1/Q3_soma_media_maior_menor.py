...
def soma_ultima_col(n, ler_matriz):
    soma = 0
...
def main():
    ...
    ler_matriz = matriz(n,m)
    tupla = (soma_lin_1(n, ler_matriz), soma_ultima_col(n, ler_matriz), media(n,m, ler_matriz), menor(n,m, ler_matriz), maior(n,m, ler_matriz))
    print (tupla)
