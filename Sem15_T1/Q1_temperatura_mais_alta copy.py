...
# 1. Cria uma função para ler uma temperatura na forma de tupla. Leia as duas temperaturas. 
# 2. ⁠Escolhe uma escala da sua preferência para trabalhar; cria uma função para converter uma temperatura para a escala que você quer. 
# 3. Antes de comparar, verifica se cada temperatura está na escala que você quer, senão estiver, converta.
